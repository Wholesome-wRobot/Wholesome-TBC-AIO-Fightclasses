        ...
        public static void SetTalentCodes(string spec)
        {
            switch (spec)
            {
                ...
                case "BeastMaster":
                    _talentsCodes = new List<string>
                    {
                        "0520300051501200000000000000000000000000000000000000000000000000",
                        "0520300151501205010000000000000000000000000000000000000000000000",
                        "0520301151501205310510000000000000000000000000000000000000000000",
                        "0520301151501205310510505200200000000000000000000000000000000000",
                        "0520301151501205310510505201205000000000000000000000000000000000"
